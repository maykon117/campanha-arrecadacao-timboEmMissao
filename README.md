...
O script cria as tabelas, políticas, índices, campanha inicial e adiciona as tabelas à publicação `supabase_realtime`. Ao atualizar uma instalação existente, execute novamente o script para adicionar os campos de conteúdo da embalagem; os alimentos existentes são mantidos e tratados como gramas.
